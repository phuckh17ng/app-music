export const musicPlayIcon = (style) => (
  <svg
    class={`${style} w-6 h-6 dark:text-white`}
    aria-hidden="true"
...
export const musicPauseIcon = (style) => (
  <svg
    class={`${style} w-6 h-6`}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const musicNextIcon = (style) => (
  <svg
    class={style}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
...
export const musicPrevIcon = (style) => (
  <svg
    class={style}
    aria-hidden="true"
    xmlns="http://www.w3.org/2000/svg"
